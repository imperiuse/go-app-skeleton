...
const IsSkipReaperImage = true // skip usage reaper image on CI // disable because use Bitbucket CI pipelines.
// @see more here # https://www.testcontainers.org/supported_docker_environment/continuous_integration/bitbucket_pipelines/
...
func getAuthRegistryCredStr(registryToken string) string {
	mustMarshalFunc := func(s any) []byte {
